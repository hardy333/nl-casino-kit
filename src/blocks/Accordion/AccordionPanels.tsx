      ...
      {items.map((item, index) => (
        ...
        >
          <RadixAccordion.Header>
            <RadixAccordion.Trigger className="group flex w-full cursor-pointer items-center justify-between gap-4 px-5 py-4 text-left text-base font-semibold text-body transition-colors duration-200 select-none hover:bg-surface-raised/50 data-[state=open]:text-brand-hover">
              {item.question}
